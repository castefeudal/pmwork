...
export const workItemSchema = z.object({
  ...
  estimateHistory: z.array(z.object({at:z.string(), value:z.number().nonnegative().optional(), kind:z.enum(["original","revised","imported"])})).optional(),
...
export const riskSchema = z.object({
  ...
  trigger: z.string(),
  reviewDate: z.string(),
  monetaryImpact: z.number().nonnegative().optional(),
  probabilityPercent: z.number().min(0).max(100).optional(),
  residualMonetaryImpact: z.number().nonnegative().optional(),
  residualProbabilityPercent: z.number().min(0).max(100).optional(),
...
export const milestoneSchema = z.object({
  ...
  projectId: z.string(),
  title: z.string(),
  // Existing date is the current forecast; baseline and actual are distinct observations.
  date: z.string(),
