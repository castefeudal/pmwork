...
export async function generateMetadata({params}:{params:Promise<{locale:string;slug:string}>}) {
 ...
 const base=`https://castefeudal.github.io${process.env.PMWORK_BASE_PATH==='github'?'/pmwork':''}`;
...
export default async function Page({params}:{params:Promise<{locale:string;slug:string}>}){
 ...
 const structured={'@context':'https://schema.org','@type':'DefinedTerm',name:locale==='ru'?term.ruTerm:term.term,description:term.definition[locale],termCode:term.acronym,inDefinedTermSet:`https://castefeudal.github.io${process.env.PMWORK_BASE_PATH==='github'?'/pmwork':''}/${locale}/glossary/`};
